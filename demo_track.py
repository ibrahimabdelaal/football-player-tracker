...
import sys
sys.path.append("G:\Year5_Spring\track\Bytetrack\ByteTrack_ReID\yolox")
import debugpy
# debugpy.listen(5678)
...
from yolox.tracker.byte_tracker_ByteTrack import BYTETracker
