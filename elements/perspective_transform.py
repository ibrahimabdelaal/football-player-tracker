...
class Options:
    def __init__(self):
        ...
        self.nThreads = 2
        self.checkpoints_dir = os.path.join(os.getcwd(), 'weights/pytorch-two-GAN-models/soccer_seg_detection_pix2pix')
        self.norm = 'batch'
        ...
        self.name = os.path.join(os.getcwd(), 'weights/pytorch-two-GAN-models/soccer_seg_detection_pix2pix')
...
# Accessing attribute values using dot notation
# print(opt.batchSize)
# print(opt.loadSize)
